...
# isolated_tenant_paths is now tests/conftest.py's autouse fixture (Cycle
# 37) -- every test gets it, not just this file's. run_dir/app_client below
# still name it explicitly so a reader sees why TENANT.out_dir/runs_dir are
# safe to write through here.
