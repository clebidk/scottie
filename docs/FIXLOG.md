...
- Verify: full suite 1209 passed (1156 baseline + 53 net new), `ruff check .` clean. `evals/baseline/` covers article/product-page/longform `page.json` only and is byte-unchanged — no re-capture needed.
