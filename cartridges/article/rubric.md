...
4. Headline contains neither the company name nor a price.
...
7. Any health statement names the study and its population; it never promises an outcome for {{ tenant.name }} hardware.
