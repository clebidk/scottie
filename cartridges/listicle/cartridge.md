...
- Voice: plain, specific, second person or first person. No exclamation marks. No "game-changer", "unlock", "elevate", "journey". A headline template that carries one of these words itself (h16's "Game-Changer") may use it in the headline only.
