...
10. First-person attribution: if ad_brief.speaker_pov is first_person, the speaker's story (if used in an item) is attributed to "a customer" (or facts_pack.speaker_name) -- never told in the author's (Austin's) own first person. Voice has no exclamation marks and none of: "game-changer", "unlock", "elevate", "journey".
